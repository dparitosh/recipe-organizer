...
import { Brain, CheckCircle, Database, Lightning, XCircle } from '@phosphor-icons/react'
          ...
          {queryResult && (
            <div className="mt-4">
              ...
              <div className="bg-muted/30 rounded-lg p-4">
                <pre className="text-xs overflow-auto max-h-64">{JSON.stringify(queryResult, null, 2)}</pre>
              </div>
            </div>
          )}
        </div>
