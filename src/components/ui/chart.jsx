...
function ChartTooltipContent({
  ...
  const tooltipLabel = useMemo(() => {
    ...
    if (labelFormatter) {
      return <div className={cn("font-medium", labelClassName)}>{labelFormatter(resolvedValue, payload)}</div>
    }
...
function ChartLegendContent({ className, hideIcon = false, payload, verticalAlign = "bottom", nameKey, ...props }) {
  const { config } = useChart()
...
function getPayloadConfigFromPayload(config, payload, key) {
  ...
  } else if (payloadPayload && Object.prototype.hasOwnProperty.call(payloadPayload, key) && typeof payloadPayload[key] === "string") {
