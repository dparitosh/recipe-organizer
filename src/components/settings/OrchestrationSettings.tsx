...
export function OrchestrationSettings({ config, onConfigChange }: OrchestrationSettingsProps) {
  const handleOrchestrationChange = (field: string, value: string | number | boolean) => {
    onConfigChange({
      orchestration: {
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                type="number"
                value={config.orchestration.defaultTargetBatchSize}
                onChange={(e) => handleOrchestrationChange('defaultTargetBatchSize', parseFloat(e.target.value))}
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Select
                value={config.orchestration.defaultTargetUnit}
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between p-4 bg-muted/30 rounded-lg">
              ...
              <Switch
                ...
                checked={config.orchestration.includeNutrients}
            ...
            <div className="flex items-center justify-between p-4 bg-muted/30 rounded-lg">
              ...
              <Switch
                id="include-costs"
                checked={config.orchestration.includeCosts}
          ...
          <div className="space-y-2">
            ...
            <Input
              id="max-history"
              type="number"
              value={config.orchestration.maxHistoryItems}
              onChange={(e) => handleOrchestrationChange('maxHistoryItems', parseInt(e.target.value))}
              min={1}
              max={100}
            />
