...
import { FormulationAPI, ManufacturingAPI, SalesOrderAPI, ValidationAPI } from '@/lib/api/rest-endpoints'
import { createEmptyFormulation } from '@/lib/schemas/formulation'
import { toast } from 'sonner'

export function APITester() {
  const [activeEndpoint, setActiveEndpoint] = useState('formulation-create')
