...
export function runCalculationEngineExample() {
  const exampleFormulation: Formulation = {
    id: 'formula-001',
  ...
  const customDensityMap: DensityMap = {
  ...
  const plantConstraints: PlantConstraints = {
    roundingRules: [
  ...
  const request1: CalculationEngineRequest = {
  ...
  const request2: CalculationEngineRequest = {
    formulation: exampleFormulation,
    bom: exampleBOM,
    targetBatchSize: 500,
    targetUnit: 'kg',
  ...
  const request3: CalculationEngineRequest = {
    formulation: exampleFormulation,
