...
import { calculateYield } from '@/lib/engines/yield.js'
import { scaleFormulation, convertUnits } from '@/lib/engines/scaling.js'
...
/**
 * Build a representative production formulation used across the integration suite.
 * @returns {Formulation}
 */
const createProductionFormulation = () => ({
  id: 'prod-formula-1',
