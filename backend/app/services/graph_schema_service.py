...
class GraphSchemaService:
    ...
    DEFAULT_SCHEMA: Dict[str, Any] = {
        ...
        "description": (
            ...
            "FDC enrichment, GraphRAG retrieval, persisted agent outputs, and ISA-88 manufacturing standards."
        ),
        "defaults": {
            "node": {
                "color": "#1e293b",
        ...
        "node_types": [
            ...
            },
            {
                ...
                "metadata": {
                    ...
                    "indexed_properties": ["operation_id", "operation_type", "equipment_type"],
            ...
            },
            {
                ...
                "metadata": {
                    ...
                    "indexed_properties": ["equipment_id", "equipment_type", "batch_size_category"],
                    "domain": "manufacturing",
                    "vector_property": None,
                },
            },
            {
                ...
                "metadata": {
                    ...
                    "indexed_properties": ["recipe_id", "version", "product_type"],
                    "domain": "manufacturing",
                    "vector_property": None,
                },
            },
            {
                ...
                "metadata": {
                    ...
                    "indexed_properties": ["grade_id", "grade_type", "cost_multiplier"],
                    "domain": "manufacturing",
                    "vector_property": None,
                },
            },
            {
                ...
                "metadata": {
                    ...
                    "indexed_properties": ["parameter_id", "parameter_name", "measurement_method"],
                    "domain": "quality",
                    "vector_property": None,
                },
            },
            {
                ...
                "metadata": {
                    "primary_key": "cost_id",
                    "indexed_properties": ["cost_id", "batch_size", "scale_category"],
                    "domain": "finance",
                    "vector_property": None,
                },
            },
        ...
        "relationship_types": [
            ...
            {
                "type": "HAS_PROCESS_RECIPE",
                "label": "Has Process Recipe",
                "color": "#dc2626",
                "style": "solid",
                "width": 2.5,
                "target_arrow": "triangle",
            ...
            {
                "type": "REQUIRES_OPERATION",
                "label": "Requires Operation",
                "color": "#f97316",
                "style": "solid",
                "width": 2,
                "target_arrow": "triangle",
                "allowed_source_types": ["ProcessRecipe", "ProcessStep"],
                "allowed_target_types": ["UnitOperation"],
                "metadata": {
                    "cardinality": "many-to-many",
                    "sequence_property": "sequence_order",
                },
            },
            {
                "type": "USES_EQUIPMENT",
                ...
                "width": 2,
                "target_arrow": "triangle",
                "allowed_source_types": ["UnitOperation", "Plant"],
                "allowed_target_types": ["Equipment"],
                "metadata": {
                    "cardinality": "many-to-many",
                },
            },
            {
                "type": "HAS_MATERIAL_GRADE",
                "label": "Has Material Grade",
                "color": "#7c3aed",
                "style": "solid",
                "width": 2,
                "target_arrow": "triangle",
                "allowed_source_types": ["Ingredient", "Formulation"],
                "allowed_target_types": ["MaterialGrade"],
                "metadata": {
                    "cardinality": "many-to-one",
                },
            },
            {
                "type": "MEASURES_QUALITY",
                "label": "Measures Quality",
                "color": "#059669",
                "style": "solid",
                "width": 2,
                "target_arrow": "triangle",
                "allowed_source_types": ["UnitOperation", "ProcessRecipe"],
                "allowed_target_types": ["QualityParameter"],
                "metadata": {
                    "cardinality": "many-to-many",
                },
            },
            {
                "type": "HAS_MANUFACTURING_COST",
                "label": "Has Manufacturing Cost",
                "color": "#9333ea",
                "style": "solid",
                "width": 2,
                "target_arrow": "triangle",
                "allowed_source_types": ["ProcessRecipe", "Formulation"],
                "allowed_target_types": ["ManufacturingCost"],
                "metadata": {
                    "cardinality": "one-to-many",
                },
            },
            {
                "type": "COST_INCLUDES_OPERATION",
                "label": "Cost Includes Operation",
                "color": "#a855f7",
                "style": "dashed",
                "width": 1.5,
                "target_arrow": "vee",
                "allowed_source_types": ["ManufacturingCost"],
                "allowed_target_types": ["UnitOperation"],
                "metadata": {
                    "cardinality": "many-to-many",
                    "cost_breakdown": True,
