...
Write-Host "Stopping frontend dev server on port $Port..."
...
if (-not $connections) {
    Write-Host "No frontend process appears to be listening on port $Port."
    return
}
...
Write-Host "Frontend service stopped (if it was running)."
